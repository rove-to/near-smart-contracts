...
class RockNFT {
    ...
    async initMetaverse(signerAccountId: string, contractAccountID: string, metaverseID: string, totalSupply: number, price: string, attachedDeposit: string) {
        this.near = await connect(this.config);
        try {
